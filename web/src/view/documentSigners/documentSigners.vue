<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="count字段" prop="count" width="120" />
        <el-table-column align="left" label="fullname字段" prop="fullname" width="120" />
        <el-table-column align="left" label="title字段" prop="title" width="120" />
        <el-table-column align="left" label="按钮组">
            <template #default="scope">
            <el-button type="primary" link icon="edit" size="small" class="table-button" @click="updateDocumentSignersFunc(scope.row)">变更</el-button>
    ...
    <el-dialog v-model="dialogFormVisible" :before-close="closeDialog" title="弹窗操作">
      <el-form :model="formData" label-position="right" ref="elFormRef" :rules="rule" label-width="80px">
        ...
        <el-form-item label="fullname字段:"  prop="fullname" >
          <el-input v-model="formData.fullname" :clearable="true"  placeholder="请输入" />
        </el-form-item>
        <el-form-item label="title字段:"  prop="title" >
          <el-input v-model.number="formData.title" :clearable="true" placeholder="请输入" />
        </el-form-item>
      </el-form>
      <template #footer>
