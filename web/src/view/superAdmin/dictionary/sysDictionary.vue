<template>
  <div>
    <warning-bar
      title="Get the dictionary and the cache method has been encapsulated in the front-end utils/dictionary. No need to write it yourself. Use the method to view the comments in the file"
    />
    ...
    <div class="gva-table-box">
      ...
      >
        ...
        <el-table-column align="left" label="Description" prop="desc" width="280" />
...
const rules = ref({
  name: [
    {
      required: true,
      message: 'Please enter a dictionary name',
      trigger: 'blur',
    },
  ],
  type: [
    {
      required: true,
      message: 'Please enter a dictionary type',
      trigger: 'blur',
    },
  ],
  desc: [
