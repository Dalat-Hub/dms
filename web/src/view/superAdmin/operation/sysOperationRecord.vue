  ...
  <div>
    ...
    <div class="gva-table-box">
      <div class="gva-btn-list">
        ...
        <el-popover v-model="deleteVisible" placement="top" width="160">
          ...
          <div style="text-align: right; margin-top: 8px;">
            ...
            <el-button size="small" type="primary" @click="onDelete">Yes</el-button>
          </div>
          <template #reference>
      ...
      >
        ...
        <el-table-column align="left" label="Operator" width="180">
        ...
        <el-table-column align="left" label="Code" prop="status" width="120">
          <template #default="scope">
            <div>
        ...
        <el-table-column align="left" label="Path" prop="path" width="240" />
        <el-table-column align="left" label="Request" prop="path" width="100">
          <template #default="scope">
            <div>
        ...
        <el-table-column align="left" label="Operations" width="100">
          <template #default="scope">
            <el-popover v-model="scope.row.visible" placement="top" width="200">
              <p>You sure you want to delete it?</p>
              <div style="text-align: right; margin-top: 8px;">
