<template>
  <el-drawer v-model="drawer" title="Thư viện ảnh" size="650px">
    <warning-bar
      title="Click &quot;File Name/Remark&quot; to edit the file name or remark content."
    />
    <div class="gva-btn-list">
      ...
      <el-form ref="searchForm" :inline="true" :model="search">
        <el-form-item label="">
          <el-input v-model="search.keyword" class="keyword" placeholder="Nhập tên tập tin" />
        </el-form-item>

        <el-form-item>
          <el-button size="small" type="primary" icon="search" @click="open">Tìm kiếm</el-button>
        </el-form-item>
      </el-form>
    </div>
    <div class="media">
...
const editFileNameFunc = async(row) => {
  ElMessageBox.prompt('Please enter a file name or remarks', 'Edit', {
