...
func GetGoogleOauthToken(code string) (*GoogleOauthToken, error) {
	...
	values.Add("client_id", global.GVA_CONFIG.GoogleOAuth.ClientID)
	values.Add("client_secret", global.GVA_CONFIG.GoogleOAuth.ClientSecret)
	values.Add("redirect_uri", global.GVA_CONFIG.GoogleOAuth.RedirectURL)
